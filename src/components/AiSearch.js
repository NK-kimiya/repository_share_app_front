...
const AiSearch = () => {
  ...
  return (
    <div>
      <button onClick={openModal} className='ai-search-modal-open-btn'><CiChat2 /></button>
      {isModalOpen && (
          ...
          <button onClick={handleSearch} style={{ marginLeft: '10px', padding: '8px 16px' }} className='search-button'>
            検索
          </button>
          <button onClick={closeModal} className='ai-search-close-button'>×</button>
